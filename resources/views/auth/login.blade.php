...
<div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
               ...
               @csrf
                  <!-- Email Address -->
                    <div class="form-group">
                        ...
                        <x-input id="email" class="form-control" placeholder="Enter your username" type="email" name="email" :value="old('email')" required autofocus />
                    </div>
                  <!-- Password -->
            ...
            <a class="btn btn-info m-1 btn-sm" href="{{ Route('tofacebook') }}"><i class="fab fa-facebook"></i>Login With Facebook</a>
          </div><!-- login-wrapper -->
      </div><!-- overlay-body -->
    </div><!-- d-flex -->
